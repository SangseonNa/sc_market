...
//	private MapPOIItem poiItem;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		MapPOIItem poiItem1 = null;
		poiItem1 = new MapPOIItem();
		poiItem1.setItemName("좌포 바꾼것");
		poiItem1.setMapPoint(MapPoint.mapPointWithGeoCoord(34.9457942,
				127.494057));
		...
		MapPOIItem poiItem2 = null;
		poiItem2 = new MapPOIItem();
		poiItem2.setItemName("테스트용");
		poiItem2.setMapPoint(MapPoint.mapPointWithGeoCoord(34.94570277713013,
				127.4940457842219));
		...
		MapPOIItem poiItem3 = null;
		poiItem3 = new MapPOIItem();
		poiItem3.setItemName("테스트용");
		poiItem3.setMapPoint(MapPoint.mapPointWithGeoCoord(34.94560362775684,
				127.4940451894741));
		poiItem3.setMarkerType(MapPOIItem.MarkerType.RedPin);
		poiItem3.setShowAnimationType(MapPOIItem.ShowAnimationType.DropFromHeaven);
		poiItem3.setTag(13);
		mapView.addPOIItem(poiItem3);
		
		
		MapPOIItem poiItem4 = null;
		poiItem4 = new MapPOIItem();
		poiItem4.setItemName("테스트용");
		poiItem4.setMapPoint(MapPoint.mapPointWithGeoCoord(34.94551804327057,
				127.49403372916782));
		poiItem4.setMarkerType(MapPOIItem.MarkerType.BluePin);
		poiItem4.setShowAnimationType(MapPOIItem.ShowAnimationType.DropFromHeaven);
		poiItem4.setTag(41);
		...
		ImageButton testbtn = (ImageButton)findViewById(R.id.btntest);
